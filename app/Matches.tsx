...
export default function Matches() {
  ...
  const [selectedProfileForDetail, setSelectedProfileForDetail] = useState(null); // Added state
                ...
                <div className="flex items-center gap-4">
                  <div className="relative">
                    {match.profile_photo_url ? (
                      ...
                      <div 
                        className="w-16 h-16 rounded-full flex items-center justify-center text-white font-semibold text-xl cursor-pointer hover:opacity-80 transition-opacity"
